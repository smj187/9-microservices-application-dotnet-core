...
{
    public class AddRoleToUserCommandHandler : IRequestHandler<AddRoleToUserCommand, InternalUserModel>
    {
        private readonly IApplicationUserRepository _applicationUserRepository;
        private readonly IAdminService _adminService;
        private readonly UserManager<InternalIdentityUser> _userManager;

        public AddRoleToUserCommandHandler(IApplicationUserRepository applicationUserRepository, IAdminService adminService, UserManager<InternalIdentityUser> userManager)
        {
        ...
        public async Task<InternalUserModel> Handle(AddRoleToUserCommand request, CancellationToken cancellationToken)
        {
            ...
            var identityUser = await _adminService.AddRoleToUser(request.UserId, request.Roles);
