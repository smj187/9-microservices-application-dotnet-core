    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ImageBlobId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ImageUrl", x => new { x.ImageBlobId, x.Id });
                    table.ForeignKey(
                        name: "FK_ImageUrl_Images_ImageBlobId",
