...
{
    public class PatchSetVisibilityCommandHandler : IRequestHandler<PatchSetVisibilityCommand, Set>
    {
        private readonly ISetRepository _setRepository;

        public PatchSetVisibilityCommandHandler(ISetRepository setRepository)
        {
            _setRepository = setRepository;
        }

        public async Task<Set> Handle(PatchSetVisibilityCommand request, CancellationToken cancellationToken)
        {
            ...
            set.ChangeVisibility(request.IsVisible);
